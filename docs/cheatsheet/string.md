...
| `lastIndexOf` | `str.lastIndexOf(subStr)` | `int` | Trả về vị trí cuối cùng tìm thấy (hoặc -1) |
...
```java
// 1. Dùng String.join
String[] words = {"Java", "DSA", "Handbook"};
String joined = String.join(" - ", words); // "Java - DSA - Handbook"

// 2. Chuyển đổi và thao tác ký tự
String s = "anagram";
